...
It's a dedicated Microsoft flagship<sup>⛵</sup>, where <sub>[![.NET](https://img.shields.io/badge/.NET-512BD4?logo=dotnet&logoColor=fff)](#)</sub> is the ship and <sub>[![C#](https://custom-icon-badges.demolab.com/badge/C%23-%23239120.svg?logo=cshrp&logoColor=white)](#)</sub> is the flag.
...
In addition to new features, each annual release enhances the performance of key components. Learning resources are best-of-the-breed for newcomers and skilled, accompanied by free for educational and personal use IDEs.<sup><mark>⌨️</mark></sup>
...
* Genuine `C++` or `Perl` experts are legitimate in branding `C#` as "yet another _Basic_". Veterans of JavaScript and pioneers of TypeScript will find it too rigid. 
...
<div align="right"><samp>🌔 2020-2026.. <b>B</b>yteshausMeister</samp> ___________<br />:end:</div>
