...
Fun fact: searching for _von Neumann_ (without the first name) will first recite namesake artifacts, like theorems.
...
Here are some more facts: https://history.computer.org/pioneers/perlis.html
...
A rare practicing engineer among IT founders.<sup>⤵️</sup> The dedicated article: [How Charles Bachman invented the DBMS](https://cacm.acm.org/opinion/how-charles-bachman-invented-the-dbms-a-foundation-of-our-digital-world/).
