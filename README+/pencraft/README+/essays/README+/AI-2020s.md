...
In the heat records-breaking mid-2020s _Artificial Intelligence_ is on trend again. Nobody will dodge this "IntelliSteamPunk" festival &thinsp;&mdash;&thinsp; __AI__ and __GPT__ are in every other lecture, article, or product release.[^1]

[^1]: Said not for the effect: I hardly found a non-AI entry in the Digital Festival 2024 program: «Failed with TDD?» ... to land on the ChatGPT-stuffed presentation. Well, it inspired me to [rethink TDD](../../../../software/tests/asDrive/README+/TDD-Watershed/README.md) but it's another story.
