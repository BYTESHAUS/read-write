...
> ### Let's put aside LLMs, neural networks, math, focus on _intelligence_ and _consciousness_, and go ahead with ...
> 
...
Nobody will dodge this "IntelliSteamPunk" festival &thinsp;&mdash;&thinsp; __AI__ and __GPT__ are in every other lecture, article, or product release.[^1]
...
* The progress of computing powers allowed _assisted mathematical proofs_ &nbsp;&mdash;&nbsp; very desired but impossible before.\
...
Famous brands apply "AI" to everything (like TV sets), and myriad startups seize the moment to sell sn**AI**ke oil for everything: from a toothbrush to fortune-telling (to name the decent).
